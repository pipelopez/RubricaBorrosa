...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    ArrayList<String> vectorDatos = new ArrayList();
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Heteroevaluador", "Coevaluador", "Autoevaluador" }));

        jLabel4.setText("Nombre del criterio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            case 0:
                vectorDatos.add("Hetero");
                break;
            case 1:
                vectorDatos.add("Co");
                break;
            case 2:
                vectorDatos.add("Auto");
                break;
        }
        
        vectorDatos.add(jTextField2.getText());
    ...
    private void jbContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbContinuarActionPerformed
        ...
        vectorDatos.add(0,jTextField1.getText());
        vectorDatos.add(1,Integer.toString(jComboBox1.getSelectedIndex() + 1));
        
        
        
        VentanaCriterios vc = new VentanaCriterios(vectorDatos);
        vc.setVisible(true);
